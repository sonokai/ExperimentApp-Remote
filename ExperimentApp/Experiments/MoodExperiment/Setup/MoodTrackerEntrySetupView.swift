    ...
    var body: some View {
        VStack {
            ...
            Text("The more entries you have, the more your results can conclude.")
                ...
                .font(.caption)
                .padding(1)
            Text("1-2 entries: A general idea of how your mood is throughout the day")
                .frame(maxWidth: .infinity, alignment: .leading)
                .font(.caption)
                .padding(1)
            Text("2-5 entries: Statistical significance concerning your mood fluctuation patterns")
                .frame(maxWidth: .infinity, alignment: .leading)
                .font(.caption)
                .padding(1)
            Text("5-10 entries: Make conclusions about your mood fluctuation patterns")
                .frame(maxWidth: .infinity, alignment: .leading)
                .font(.caption)
                .padding(1)
            HStack{
