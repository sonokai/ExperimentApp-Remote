...
struct FinishedExperiment: Identifiable, Codable{
    ...
    init(id: UUID = UUID(), name: String, startDate: Date, endDate: Date, insights: [String], medal: Medal){
        self.id = id
        self.name = name
